                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            ...
                            <label for="rtfPrice" class="d-flex justify-content-between">₹1 - ₹99 <button
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rftPrice" value="99,199" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rftPrice" class="d-flex justify-content-between">₹99 - ₹199 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="199" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between"> ₹199+ <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
