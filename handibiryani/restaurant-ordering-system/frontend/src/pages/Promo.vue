    ...
    <div class="promotions">
        ...
        <div class="promotions-item">
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        <tr>
                            <td class="align-middle">08:00 - 09:00</td>
                            <td class="bg-light-gray">
                               
                            </td>
                            <td>
                                <span class="bg-brown activity-name">Breakfast time</span>
                                <div class="activity-time"> 10% Discount on Non Veg Items </div>
                            </td>
                        ...
                        <tr>
                            <td class="align-middle">18:00 - 23:00</td>
                            <td class="bg-light-gray">
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                ...
                <ul>
                    <li>
                        <p>10% Discount on Non Veg Items</p>
                    </li>
                    <li>
                        <p>Enjoy Delicious Food All Day</p>
                    </li>
                    <li>
                        <p>Dine In Offer Only</p>
                    </li>
                </ul>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>Thursday Thirst</h3>
                <ul>
                    <li>
                        <p>Best Non Veg Items in Town at 10% OFF</p>
                    </li>
                    <li>
                        <p>Enjoy Chicken,Mutton,Biryani and Many More Items </p>
                    </li>
                    <li>
                        <p>Visit Handi Biryani Wala , Muzaffarpur</p>
                    </li>
                </ul>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
