    ...
    <div class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Biryani
                </router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Paratha</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Egg</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Dal</router-link>
            </div>
            ...
            <div class="box">
                <h3>opening hours</h3>
                <p>everyday : 8:00am to 11:00pm</p>
